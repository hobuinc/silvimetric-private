...
# ADD CPP /nologo /MD /W3 /GX /Od /I "..\..\common\array2d" /I "..\..\common\FUSION_util" /I "..\..\common\LTK" /I "..\..\common\TerrainSet" /I "..\..\common\image" /I "\Bob's Stuff\Code from other people\lastools_latest" /D "WIN32" /D "NDEBUG" /D "_CONSOLE" /D "_MBCS" /D "_AFXDLL" /FR /Yu"stdafx.h" /FD /c
...
# ADD LINK32 ..\..\common\image\tlib.lib ..\..\common\jpeg-7\libjpeg.lib /nologo /subsystem:console /machine:I386 /out:"\fusion_demo\gridmetrics.exe" /out:"/fusion_demo/GridMetrics.exe"
...
# ADD CPP /nologo /MTd /W3 /Gm /GX /ZI /Od /I "..\..\common\array2d" /I "..\..\common\FUSION_util" /I "..\..\common\LTK" /I "..\..\common\TerrainSet" /I "..\..\common\image" /I "\Bob's Stuff\Code from other people\lastools_latest" /D "WIN32" /D "_DEBUG" /D "_CONSOLE" /D "_MBCS" /Yu"stdafx.h" /FD /GZ /c
...
# ADD LINK32 ..\..\common\image\tlib.lib ..\..\common\jpeg-7\libjpeg.lib /nologo /subsystem:console /debug /machine:I386 /nodefaultlib:"libc" /out:"\fusion_demo\gridmetrics.exe" /pdbtype:sept /out:"/fusion_demo/GridMetrics.exe"
